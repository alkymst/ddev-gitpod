[![Gitpod ready-to-code](https://img.shields.io/badge/Gitpod-ready--to--code-blue?logo=gitpod)](https://gitpod.io/#https://github.com/alkymst/ddev-gitpod)
...
1. Click on the following link
  https://gitpod.io/#https://github.com/alkymst/ddev-gitpod
...
1. Gitpod - development environment based on Docker
    1. [.gitpod.yml](https://github.com/alkymst/ddev-gitpod/blob/main/.gitpod.yml)
        ...
        1. Run initial commands using 3 terminals in parallel:
            ...
            1. `composer install`
            1. `sudo docker-up`
    1. [.gitpod.Dockerfile](https://github.com/alkymst/ddev-gitpod/blob/main/.gitpod.Dockerfile)
...
1. ddev - ridiculously simple setup for complex development environments
    1. [.ddev/config.yaml](https://github.com/alkymst/ddev-gitpod/blob/main/.ddev/config.yaml) - main ddev (default) configuration, can be generated by running `ddev config`
    1. [.ddev/gitpod-setup-ddev.sh](https://github.com/alkymst/ddev-gitpod/blob/main/.ddev/gitpod-setup-ddev.sh) - generate config overrides for ddev to work in the Gitpod environment.
